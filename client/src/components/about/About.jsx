            ...
            <h2 className="features-heading-text underline1 op">Meet Our Developers</h2>
                ...
                <div className="dev-container">
                    ...
                    <div className="pro">
                        <img src={Loovimg} alt="" />
                        <div className="des">
                            <span>Lov Kumawat</span>
                            <h4>Front End Developer</h4>
                            <a href="https://github.com/Lovkumawat">
                                {/* <i className="fab fa-github"></i> */}
                                <FaGithub/>
                                </a>
                            <a href="https://www.linkedin.com/in/lov-kumawat-a84861252/"><FaLinkedin/></a>
                        </div>
                    </div>

                    <div className="pro">
                        <img src={Rashiimg} alt="" />
                        <div className="des">
                            <span>Rashi Mall</span>
                            <h4>Front End Developer</h4>
                            <a href="https://github.com/rmall2003">
                                {/* <i className="fab fa-github"></i> */}
                                <FaGithub/>
                                </a>
                            <a href="https://www.linkedin.com/in/rashi-mall-b1b878271/"><FaLinkedin/></a>
                        </div>
                    </div>
                </div>
            </section>
